...
public class PriorityVoteService {
    ...
    public PriorityVoteService(PriorityVoteRepository priorityVoteRepository, IdeaRepository ideaRepository, AuditLogService auditLogService) {
        this.priorityVoteRepository = priorityVoteRepository;
        this.ideaRepository = ideaRepository;
        this.auditLogService = auditLogService;
    }

    public PriorityVote vote(String ideaId, String voterEmail, PriorityVoteRequest request) {
        ...
        PriorityVote vote = priorityVoteRepository.save(new PriorityVote(ideaId, voterEmail, request.score()));
